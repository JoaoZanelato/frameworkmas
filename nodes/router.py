...
_ROUTER_SYSTEM_PROMPT = (
    ...
    "   - PF: crédito pessoal, consignado, veículos, cartão de crédito, habitação, previdência, seguro de vida.\n"
    "   - PJ: capital de giro, recebíveis, duplicatas, crédito empresarial, CNPJ, conta PJ, maquininha.\n"
    "   - CAMPANHAS: campanhas promocionais, movimentação do bem, capitalização, consórcio, pontos, sorteios, prêmios.\n\n"
    ...
    "Perguntas curtas como 'e o trator?', 'carência?' ou 'como funciona o bem?' devem virar queries explícitas "
